...
namespace TunaszUtils
{
    ...
    public static void DefaultListSize<T>(this List<T> listToChange, int amount, T defaultValue)
    {
        ...
        /// <summary>
        /// Checks if the layer is inside this layer mask
        /// </summary>
        ...
        /// <param name="layer"></param>
        /// <returns></returns>
        public static bool Contains(this LayerMask layermask, Enum layer)
        {
            return layermask == (layermask | (1 << Convert.ToInt32( layer)));
        }
    }
}